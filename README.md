...
**Estimated Time:** 1-2 days of focused work (you have one week to accommodate your university and other commitments)
...
- Implement a single callout node with an attribute called type. The type attribute represents the type of callout (Information, Best Practice, Warning, and Error)
...
- Ensure all LLM-modified content remains valid for the editor's components, including custom ones
...
2. Create a file named **README.md** in your repository including:
   ...
   2. A short video demonstrating the callout component in use (including any custom menus or slash commands you implemented)
   3. Info on the keyboard shortcut you have bound to the callout component
